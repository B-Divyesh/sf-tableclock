# Tableclock: a multi-device turn timer / N-player chess clock for board-game tables (`tableclock`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://tableclock.sociobot.in`. Artifact class: `pwa-offline`.
