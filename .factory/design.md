...
The setup illustration is an original, model-generated overhead still life of five abstract phones around a tabletop, reduced to a four-ink halftone print. It explains the product's multi-device/table context without depicting capabilities that do not exist. App icons are hand-authored SVG/PNG: a circular turn arrow around four table spots, using the same inks.

Prompt sheet: “overhead editorial still life of a board-game table, five generic blank smartphones arranged radially around a small abstract tabletop path, hands absent, chunky cardboard counters and a sand timer, 1960s tabletop rulebook spot-colour screen print, coarse halftone dots, imperfect ink registration, uncoated cream paper, tomato red, petrol blue, charcoal black and muted ochre, strong simple silhouettes, generous negative space, landscape composition, no text, no watermark, no logos, no brands, no people, no copyrighted game pieces, no gradients, no photorealism.”

Generated with the factory image model (`factory-image`, Azure OpenAI image generation) on 2026-08-27. The chosen output and prompt sidecar are retained in `assets/src/`; the web exports are derived WebP/AVIF files. The generated art is original to this product. Icons are authored for Tableclock in-repository and released under the project MIT license.
